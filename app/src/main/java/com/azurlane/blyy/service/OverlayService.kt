...
class OverlayService : Service(), LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner {
    ...
    companion object {
        const val ACTION_SHOW = "com.azurlane.blyy.action.SHOW_OVERLAY"
        const val ACTION_HIDE = "com.azurlane.blyy.action.HIDE_OVERLAY"
        const val ACTION_TOGGLE = "com.azurlane.blyy.action.TOGGLE_OVERLAY"
